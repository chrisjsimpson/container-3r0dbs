...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3r0dbs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3r0dbs.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-3r0dbs.git
cd container-3r0dbs
```
...
```
docker attach container-3r0dbs
```
